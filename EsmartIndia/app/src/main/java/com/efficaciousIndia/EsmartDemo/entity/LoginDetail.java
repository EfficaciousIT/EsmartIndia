...
public class LoginDetail {
    ...
    public String getIntStudentID_Number() {
        return intStudentID_Number;
    }

    public void setIntStudentID_Number(String intStudentID_Number) {
        this.intStudentID_Number = intStudentID_Number;
    }

    @SerializedName("intStudentID_Number")
    @Expose
    private String intStudentID_Number;
    ...
    public String toString() {
        return "LoginDetail{" +
                "vchFCMTOken='" + vchFCMTOken + '\'' +
                ", vchEmaIl='" + vchEmaIl + '\'' +
                ", intUserId=" + intUserId +
                ", intSchoolIid=" + intSchoolIid +
                ", intUserTypeId=" + intUserTypeId +
                ", intStudentId=" + intStudentId +
                ", vchStudentFirstName='" + vchStudentFirstName + '\'' +
                ", vchStudentLastName='" + vchStudentLastName + '\'' +
                ", name='" + name + '\'' +
                ", std='" + std + '\'' +
