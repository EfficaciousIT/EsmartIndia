...
import com.efficaciousIndia.EsmartDemo.adapters.Teacher_Mark_Adapter;
...
//                            tv_dateSelection.setText(dayOfMonth + "-" + (monthOfYear + 1) + "-" + year);
    ...
    public void AttendanceMark() {
        ...
        try
        {
//            ArrayList<AttendanceDetail> teacherlist=((Staff_Mark_Adapter)madapter).getTchrList();
...
//            mCompositeDisposable.add(service.getAttendanceDetails(command,Schooli_id,"4","","",academic_id,Selected_Date,"","")
