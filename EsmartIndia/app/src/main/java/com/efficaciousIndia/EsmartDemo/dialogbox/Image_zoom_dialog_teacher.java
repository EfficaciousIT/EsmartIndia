...
//            }
            if (role_id.equals("5")) {
                if (Teacher_Calender_attendence.intMobileNo!=null ) {
                    if(!Teacher_Calender_attendence.intMobileNo.isEmpty()){
                        mobile_no = Teacher_Calender_attendence.intMobileNo;
                        image = Teacher_Calender_attendence.image;
                    }
                }
                ...
                if (Staff_Calender_attendence.intMobileNo!=null ) {
                    if(!Staff_Calender_attendence.intMobileNo.isEmpty()){
                        mobile_no = Staff_Calender_attendence.intMobileNo;
                        image=Staff_Calender_attendence.image;
                    }
                }
