...
import com.efficaciousIndia.EsmartDemo.MultiImages.activities.MainImages;
        ...
        try {
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                ...
                for (int i = 0; i < taskListDataList.size(); i++) {
                    ...
                    Toast.makeText(this, String.valueOf(taskListDataList.get(i).getEventName()), Toast.LENGTH_LONG).show();
                    dataList2.add(map);
                }
