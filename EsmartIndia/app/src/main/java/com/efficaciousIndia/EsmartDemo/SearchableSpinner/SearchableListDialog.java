package com.efficaciousIndia.EsmartDemo.SearchableSpinner;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    private String _strTitle,_strHint;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String strTitle = _strTitle == null ? getString(R.string.search) : _strTitle;
    ...
    private void setData(View rootView) {
        ...
        _searchView.setQueryHint(_strHint);
