...
import com.efficaciousIndia.EsmartDemo.dialogbox.Image_zoom_dialog_teacher;
import com.efficaciousIndia.EsmartDemo.entity.AttendanceDetail;
import com.efficaciousIndia.EsmartDemo.entity.AttendanceDetailPojo;
import com.efficaciousIndia.EsmartDemo.entity.ProfileDetail;
...
public class Staff_Calender_attendence extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        profileimg.setOnClickListener(view -> {
            try {
//                Toast.makeText(getContext(), "Profile Image", Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(getContext(), "intMobileNo"+intMobileNo, Toast.LENGTH_SHORT).show();
