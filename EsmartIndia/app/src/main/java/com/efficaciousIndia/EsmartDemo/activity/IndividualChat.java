...
import com.efficaciousIndia.EsmartDemo.FCMServices.FirebaseChatMainApp;
...
public class IndividualChat extends AppCompatActivity {
    ...
    String ReceiverName, ReceiverId, ReceiverFCMToken, SenderName, ReceiverUserTypeId, role_id, UserSelectedForNotification;
    ImageButton btnSend;
