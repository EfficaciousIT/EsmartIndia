...
import com.efficaciousIndia.EsmartDemo.adapters.GalleryAdapter;
import com.efficaciousIndia.EsmartDemo.dialogbox.Gallery_dialogBox;
    ...
    public void generateImageList(ArrayList<SchoolDetail> taskListDataList) {
        try {
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                adapter = new GalleryAdapter(taskListDataList, getActivity(),Folder_id);
