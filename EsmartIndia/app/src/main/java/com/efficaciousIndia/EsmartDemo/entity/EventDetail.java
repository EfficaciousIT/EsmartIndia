...
public class EventDetail {
    ...
    public EventDetail(Integer intStandard_Id, Integer intDivision_Id, Integer intUserId, Integer intUserTypeId, Integer intAcademicId, Integer intSchoolId, Integer intEventId) {
