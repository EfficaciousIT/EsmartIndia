...
public class ProfileDetail {
    ...
    @SerializedName("dtresultdate")
    @Expose
    private String dtresultdate;

    public String getDtresultdate() {
        return dtresultdate;
    }

    public void setDtresultdate(String dtresultdate) {
        this.dtresultdate = dtresultdate;
    }
    ...
    public String toString() {
        return "ProfileDetail{" +
                ...
                ", intAcademicId=" + intAcademicId +
                ", vchFatherNAme='" + vchFatherNAme + '\'' +
                ", intUserid=" + intUserid +
                ", vchMotherNAme='" + vchMotherNAme + '\'' +
                ", intRollNO='" + intRollNO + '\'' +
                ", vchStandardname='" + vchStandardname + '\'' +
                ", vchDivisionNAme='" + vchDivisionNAme + '\'' +
                ", lastName='" + lastName + '\'' +
                ", intAdminId=" + intAdminId +
                ", vchImageURL='" + vchImageURL + '\'' +
                ", vchFirstName='" + vchFirstName + '\'' +
                ", vchEmail='" + vchEmail + '\'' +
                ", intMobileNo='" + intMobileNo + '\'' +
                ", vchAddress='" + vchAddress + '\'' +
                ", intStudentId=" + intStudentId +
                ", intTeacherId=" + intTeacherId +
                ", intPrincipalId=" + intPrincipalId +
                ", intManagerId=" + intManagerId +
                ", dtresultdate=" + dtresultdate +
                '}';
    }
}