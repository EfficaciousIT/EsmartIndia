...
public class StaffLeaveListAdapter extends RecyclerView.Adapter<StaffLeaveListAdapter.LeaveHolder> {
    ...
    @Override
    public StaffLeaveListAdapter.LeaveHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.fragment_teacherleave, parent, false);
        return new StaffLeaveListAdapter.LeaveHolder(view);
    }

    @Override
    public void onBindViewHolder(final StaffLeaveListAdapter.LeaveHolder holder, final int position) {
