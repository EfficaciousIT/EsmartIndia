...
public class StaffApprovalAdapter  extends RecyclerView.Adapter<StaffApprovalAdapter.LeaveListHolder> {
    ...
    @Override
    public StaffApprovalAdapter.LeaveListHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.fragment_teacherleaveapply, parent, false);
        return new StaffApprovalAdapter.LeaveListHolder(view);
    }

    @Override
    public void onBindViewHolder(final StaffApprovalAdapter.LeaveListHolder holder, final int position) {
